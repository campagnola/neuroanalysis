...
class MiesNwb(object):
    ...
    def notebook(self):
        ...
        if self._notebook is None:
            ...
            if 'EntrySourceType' in nb_keys:
                entry_source_type_index = list(nb_keys).index('EntrySourceType')
            else:
                # older files may be missing EntrySourceType. There is a way
                # to determine whether the record is TP-generated, but we have not implemented
                # it here..
                entry_source_type_index = None
                raise NotImplementedError("Lab notebook does not have EntrySourceType field!")
    ...
    def sweep_groups(self, keys=('stim_name', 'V-Clamp Holding Level', 'Clamp Mode')):
